      ...
      <div className="bg-white rounded-lg p-4">
        ...
        <div className="flex flex-col md:flex-row gap-4 mt-4">
          ...
          <div className="flex flex-col gap-2 w-full md:w-auto">
            ...
            <div className="flex items-center shadowBox bg-teal rounded-lg py-12 px-12">
              <p className="text-[34px] text-white font-[700]">
                NPS <span className="text-[54px]">70</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-2 mt-4">
          ...
          <div className="shadowBox py-4 px-8 rounded w-full md:flex-1">
            ...
            <div>
              <span className="text-[70px] font-[700]">12 </span>
          ...
          <div className="shadowBox py-4 px-8 rounded w-full md:flex-1">
            ...
            <div>
              <span className="text-[70px] font-[700]">35 </span>
              <span className="text-lg font-semibold">
                orders
              </span>
            </div>
