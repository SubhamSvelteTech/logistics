...
const BookingDoneModal = ({ title,path }: { title: string, path?:string }) => {
  ...
  return (
    <Modal id="booking-done">
      ...
      <div className="flex justify-end px-4 mt-6">
        <button onClick={handleRedirect} className="text-sm px-6 py-1 text-white bg-black rounded">Done</button>
      </div>
    </Modal>
  );
};
